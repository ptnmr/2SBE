...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { coorient: @aluno.coorient, cpf: @aluno.cpf, email: @aluno.email, fone: @aluno.fone, nivel: @aluno.nivel, nome: @aluno.nome, orient: @aluno.orient, ramal: @aluno.ramal }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { coorient: @aluno.coorient, cpf: @aluno.cpf, email: @aluno.email, fone: @aluno.fone, nivel: @aluno.nivel, nome: @aluno.nome, orient: @aluno.orient, ramal: @aluno.ramal }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
